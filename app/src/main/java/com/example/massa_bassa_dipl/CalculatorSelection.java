...
public class CalculatorSelection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            getSupportActionBar().setTitle("Calculator Selection");
        }
        FirstOptionSelection =
                (Button)findViewById(R.id.FirstOptionSelection);
        SecondOptionSelection =
                (Button)findViewById(R.id.SecondOptionSelection);
        ThirdOptionSelection =
                (Button)findViewById(R.id.ThirdOptionSelection);
        FourthOptionSelection =
                (Button)findViewById(R.id.FourthOptionSelection);

        FirstOptionSelection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity();
            }
        });
        SecondOptionSelection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity2();
            }
        });
        ThirdOptionSelection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity3();
            }
        });
        FourthOptionSelection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity4();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(CalculatorSelection.this, MainMenuSelector.class);
