...
public class MainActivityPodMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            getSupportActionBar().setTitle("Cone Area Menu");
        }
        ...
        PrvaSlikaSelection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity();
            }
        });
        DrugaSlikaSelection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity2();
            }
    ...
    public void openActivity2(){
        Intent intent = new Intent(this,
                Calculator_Different_Cone_Area.class);
        startActivity(intent);
    }
