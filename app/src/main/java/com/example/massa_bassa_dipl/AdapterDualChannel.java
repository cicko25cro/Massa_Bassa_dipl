...
public class AdapterDualChannel extends RecyclerView.Adapter<AdapterDualChannel.ViewHolder> {

    private List<AmpsClass> ampsClassList;

    public AdapterDualChannel(List<AmpsClass> ampsClassList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            holder.hiddendescriptionTextView.setText("2 Channel Amplifiers");
        }
        else {
