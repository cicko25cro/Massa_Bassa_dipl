...
public class AmpMenu extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Intent intent = new Intent(AmpMenu.this,
                    HelperMenu.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amp_menu);
        ...
        getSupportActionBar().setTitle("Best of Amplifiers");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }
    public void openActivity(){
        Intent intent = new Intent(this,
                RecommenderMonoblock.class);
        startActivity(intent);
    }
    public void openActivity2(){
        Intent intent = new Intent(this,
                RecommenderTwoChannel.class);
        startActivity(intent);
    }
    public void openActivity3(){
        Intent intent = new Intent(this,
                RecommenderFourChannel.class);
        startActivity(intent);
    }
    public void openActivity4(){
        Intent intent = new Intent(this,
                RecommenderFiveChannel.class);
        startActivity(intent);
    }
