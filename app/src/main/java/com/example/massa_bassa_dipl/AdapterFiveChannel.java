...
public class AdapterFiveChannel extends RecyclerView.Adapter<AdapterFiveChannel.ViewHolder> {

    private List<AmpsClass> ampsClassList;

    public AdapterFiveChannel(List<AmpsClass> ampsClassList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            holder.hiddendescriptionTextView.setText("5 Channel Amplifiers");
        }
        else {
