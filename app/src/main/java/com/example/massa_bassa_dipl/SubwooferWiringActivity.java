...
public class SubwooferWiringActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Wiring Calculator");
        ...
        ArrayAdapter<String> numSpeakersAdapter = new ArrayAdapter<>(this,
                R.layout.custom_spinner_item, numSpeakersList);
        numSpeakersAdapter.setDropDownViewResource(R.layout.simple_custom_dropdown);
        ...
        ArrayAdapter<String> voiceCoilsAdapter = new ArrayAdapter<>(this,
                R.layout.custom_spinner_item, voiceCoilsList);
        voiceCoilsAdapter.setDropDownViewResource(R.layout.simple_custom_dropdown);
        ...
        spinnerVoiceCoils.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int
                    position, long id) {
                selectedVoiceCoilImpedance = (int)
                        getVoiceCoilImpedance(position);
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                // Not used
    ...
    private void calculateResult() {
        ...
        if (selectedNumSpeakers == 1){
            textViewResult.setText("Speaker Quantity: " + selectedNumSpeakers
                    + " speaker" +
                    "\nVoice Coil/s Impedance: " + selectedVoiceCoilImpedance
                    + " ohm" +
                    "\n \nFinal Result: " + result);
        }
        else {
