...
public class AdapterComponentsCoax extends RecyclerView.Adapter<AdapterComponentsCoax.ViewHolder> {

    private List<SubsSpeakersClass> subsSpeakersClassList2;

    public AdapterComponentsCoax(List<SubsSpeakersClass> subsSpeakersClassList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            holder.hiddendescriptionTextView.setText("5.25 Inch Component");
        } else if (position == 2) {
            holder.separator.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setText("6.5 Inch Component");
        }
        else if (position == 4) {
            holder.separator.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setText("8 Inch Component");
        }
        else if (position == 6) {
            holder.separator.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setText("5.25 Inch Coaxial");
        }
        else if (position == 8) {
            holder.separator.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setText("6.5 Inch Coaxial");
        }
        else if (position == 10) {
            holder.separator.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setVisibility(View.VISIBLE);
            holder.hiddendescriptionTextView.setText("8 Inch Coaxial");
        }
        else {
