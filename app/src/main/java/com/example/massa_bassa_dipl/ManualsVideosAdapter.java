...
public class ManualsVideosAdapter extends
        RecyclerView.Adapter<ManualsVideosAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int
            viewType) {
        View view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.item_manual_video,
                        parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.descriptionTextView.setOnClickListener(new
