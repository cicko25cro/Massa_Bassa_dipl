...
public class AdapterMonoblockAmp extends RecyclerView.Adapter<AdapterMonoblockAmp.ViewHolder> {

    private List<AmpsClass> ampsClassList;

    public AdapterMonoblockAmp(List<AmpsClass> ampsClassList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            holder.hiddendescriptionTextView.setText("Monoblock Amplifiers");
        }
        else {
